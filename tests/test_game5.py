...
import copy
from tests.sample_hands.example_hands import get_game5
import math
import random
...
loaded_player1Cards, loaded_player2Cards, loaded_player3Cards, loaded_player4Cards = get_game5()
finalBid = 4
playerTrump = loaded_player4Cards.pop(1)
trumpReveal = False
...
loaded_player4Cards =  players[3]['cards']
known = True
P3(cards,loaded_player1Cards, loaded_player2Cards, loaded_player3Cards, loaded_player4Cards,finalBid,trumpSuit,trumpReveal,currentSuit,chose,trumpPlayed,trumpIndice,reveal,currentCatch,playerChance,s,playerTrump,k,known,total=0,num=0)
