...
import copy
from tests.sample_hands.example_hands import get_game6
import math
import random
...
loaded_player1Cards, loaded_player2Cards, loaded_player3Cards, loaded_player4Cards = get_game6()
finalBid = 1
playerTrump = loaded_player1Cards.pop(3)
trumpReveal = False
